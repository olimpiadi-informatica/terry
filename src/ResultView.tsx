    ...
    return (
      <React.Fragment>
        <ul className="list-unstyled">
          {this.props.result.alerts.map((a: any, i: number) => <li key={i}>
        ...
        <dl className="terry-file-view">
          ...
          <dd>
            <ul className="list-inline mb-0">
              {this.props.result.cases.map((c: TestCase, i: number) => <li className="list-inline-item" key={i}>{this.props.renderCaseSummary(c, i + 1)}</li>)}
            </ul>
          </dd>
        </dl>
